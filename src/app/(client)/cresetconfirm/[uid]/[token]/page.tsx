...
export default function CResetConfirm() {
    ...
    const resetPassword = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        let resetRequest = await axios.post(
            `${backend_url}/client/password-reset-confirm/${params.uid}/${params.token}/`,
            {
        ...
        response === 'Password has been reset.' ? router.push('/client-login') : setError(true)
