...
export default function OfferCard(
    ...
    const handleClick = () => {
        //console.log(`element clicked for ${props.manufacturer.id}`)
        ...
        props.setManufacturerId(props.manufacturer.id)
        props.setManufacturerName(props.manufacturer.first_name)
    };
